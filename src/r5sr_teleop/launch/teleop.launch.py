...
def rviz_opaque_function(context):
    ...
    rviz_file_path = get_file_path(
        'r5sr_teleop', 'rviz/r5sr_teleop_exp.rviz') if exp_arg_value == 'true' else get_file_path('r5sr_teleop', 'rviz/r5sr_teleop.rviz')

    return [
        IncludeLaunchDescription(
            PythonLaunchDescriptionSource(
                [get_file_path('r5sr_teleop', 'launch/rviz_moveit.launch.py')]),
...
def rqt_opaque_function(context):
    ...
    if exp_arg_value == 'true' and vsting_arg_value == 'false':
        rqt_file_path = get_file_path(
            'r5sr_teleop', 'rqt/r5sr_cam_exp.perspective')
    elif exp_arg_value == 'false' and vsting_arg_value == 'true':
        rqt_file_path = get_file_path(
            'r5sr_teleop', 'rqt/r5sr_cam_vsting.perspective')
    else:
        rqt_file_path = get_file_path(
            'r5sr_teleop', 'rqt/r5sr_cam.perspective')
    ...
    return [
        ...
        Node(
            ...
            arguments=[
                '--clear-config',
                '--perspective-file', get_file_path(
                    'r5sr_teleop', 'rqt/vision_front.perspective')
            ],
        ),
    ]
        ...
        composable_node_descriptions=[
            ...
            ComposableNode(
                    ...
                    remappings=[
                        ...
                        ('flipper_joint_trajectory',
                         '/flipper_controller/joint_trajectory'),
