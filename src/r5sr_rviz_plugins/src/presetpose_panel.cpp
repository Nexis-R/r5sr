...
void PresetposePanel::onInitialize() {
  ...
  move_to_dex1_center_pose_client = node->create_client<std_srvs::srv::Empty>(
      "preset_pose_node/move_to_dex1_center_pose");
  move_to_dex1_diaright_pose_client = node->create_client<std_srvs::srv::Empty>(
      "preset_pose_node/move_to_dex1_diaright_pose");
  move_to_dex1_dialeft_pose_client = node->create_client<std_srvs::srv::Empty>(
      "preset_pose_node/move_to_dex1_dialeft_pose");

  move_to_dex1_right_pose_client = node->create_client<std_srvs::srv::Empty>(
      "preset_pose_node/move_to_dex1_right_pose");
  move_to_dex1_left_pose_client = node->create_client<std_srvs::srv::Empty>(
